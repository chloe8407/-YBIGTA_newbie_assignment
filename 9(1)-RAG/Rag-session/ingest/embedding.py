...
def embed_passages(texts: list[str], ids: list[str], progress_callback=None) -> np.ndarray:
    ...
    if not api_keys:
        raise ValueError("No API keys found. Set UPSTAGE_API_KEY or UPSTAGE_API_KEY1..N")
